...
class Ui_Wizard(object):
    def setupUi(self, Wizard):
        ...
        Wizard.setOptions(QtWidgets.QWizard.WizardOption.CancelButtonOnLeft|QtWidgets.QWizard.WizardOption.HaveFinishButtonOnEarlyPages|QtWidgets.QWizard.WizardOption.IgnoreSubTitles|QtWidgets.QWizard.WizardOption.NoBackButtonOnStartPage)
        ...
        self.activity = QtWidgets.QComboBox(parent=self.groupBox_6)
        self.activity.setObjectName("activity")
        self.activity.addItem("")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.activity)
        ...
        self.fear.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.fear.setObjectName("fear")
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.fear)
        ...
        self.difficulty.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.difficulty.setObjectName("difficulty")
        self.formLayout_2.setWidget(6, QtWidgets.QFormLayout.ItemRole.FieldRole, self.difficulty)
        ...
        self.embarassment = QtWidgets.QSlider(parent=self.groupBox_9)
        self.embarassment.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.embarassment.setObjectName("embarassment")
        self.formLayout_2.setWidget(7, QtWidgets.QFormLayout.ItemRole.FieldRole, self.embarassment)
