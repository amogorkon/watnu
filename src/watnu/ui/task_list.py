...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.status.setItemText(0, _translate("Dialog", "ready"))
        self.status.setItemText(1, _translate("Dialog", "draft"))
        self.status.setItemText(2, _translate("Dialog", "inactive"))
        self.status.setItemText(3, _translate("Dialog", "done"))
        self.status.setItemText(4, _translate("Dialog", "deleted"))
        ...
        item.setText(_translate("Dialog", "inactive"))
        item = self.task_list.horizontalHeaderItem(11)
        item.setText(_translate("Dialog", "deleted"))
