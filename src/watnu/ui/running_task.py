...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.clock_audio = QtWidgets.QPushButton(parent=self.groupBox)
        self.clock_audio.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/feather/extra/feathericons/volume-x.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.pomodoro_bar = QtWidgets.QProgressBar(parent=self.groupBox)
        ...
        self.pomodoro_bar.setTextDirection(QtWidgets.QProgressBar.Direction.TopToBottom)
