...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.visit_url = QtWidgets.QPushButton(self.common)
        self.visit_url.setEnabled(False)
        self.visit_url.setText("")
        self.visit_url.setObjectName("visit_url")
        self.verticalLayout_2.addWidget(self.visit_url)
