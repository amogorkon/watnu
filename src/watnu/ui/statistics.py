...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.total_num_tasks = QtWidgets.QLabel(self.tab)
        self.total_num_tasks.setObjectName("total_num_tasks")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.total_num_tasks)
        self.tabWidget.addTab(self.tab, "")
        self.widget = QtWidgets.QWidget()
        self.widget.setObjectName("widget")
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.widget)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.space_stats = QtWidgets.QTableWidget(self.widget)
        self.space_stats.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.space_stats.setAlternatingRowColors(True)
        self.space_stats.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        ...
        self.level_stats = QtWidgets.QTableWidget(self.widget1)
        self.level_stats.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.level_stats.setAlternatingRowColors(True)
        self.level_stats.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        ...
        self.session_stats = QtWidgets.QTableWidget(self.widget2)
        self.session_stats.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContentsOnFirstShow)
        self.session_stats.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.session_stats.setDragDropOverwriteMode(False)
        self.session_stats.setAlternatingRowColors(True)
        self.session_stats.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
