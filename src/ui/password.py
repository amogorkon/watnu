...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Passwort"))
        self.label.setText(_translate("Dialog", "Primäres Passwort"))
        self.label_2.setText(_translate("Dialog", "Sekundäres Passwort"))
        self.label_3.setText(_translate("Dialog", "Primäres Schlüsseldatei"))
        self.label_4.setText(_translate("Dialog", "Sekundäre Schlüsseldatei"))
