...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(20, 30, 621, 90))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.button6.setText(_translate("Dialog", "Wähle Supertasks aus"))
        self.button6.setShortcut(_translate("Dialog", "6"))
        self.button4.setText(_translate("Dialog", "Wähle Subtasks aus"))
        self.button4.setShortcut(_translate("Dialog", "4"))
        self.button5.setText(_translate("Dialog", "wähle Bezugsaufgabe(n)"))
        self.button5.setShortcut(_translate("Dialog", "5"))
        self.button1.setText(_translate("Dialog", "Zurücksetzen"))
        self.button1.setShortcut(_translate("Dialog", "1"))
        self.button7.setText(_translate("Dialog", "Als Graph darstellen"))
        self.button7.setShortcut(_translate("Dialog", "7"))
        self.button8.setShortcut(_translate("Dialog", "8"))
        self.button9.setText(_translate("Dialog", "Als Gantt Chart darstellen"))
