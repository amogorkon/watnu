...
class Ui_Wizard(object):
    def setupUi(self, Wizard):
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("src\\ui\\../extra/chevrons-down.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("src\\ui\\../extra/chevrons-up.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("src\\ui\\../extra/constraints.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("src\\ui\\../extra/soul.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.secondary_activity_button.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("src\\ui\\../extra/mind.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.primary_activity_button.setIcon(icon7)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("src\\ui\\../extra/skills.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.choose_skills_button.setIcon(icon9)
