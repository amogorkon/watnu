...
class Ui_Wizard(object):
    def setupUi(self, Wizard):
        ...
        self.formLayout_2.setWidget(5, QtWidgets.QFormLayout.ItemRole.LabelRole, self.choose_skills_button)
        ...
        self.formLayout_2.setWidget(6, QtWidgets.QFormLayout.ItemRole.LabelRole, self.choose_deadline_button)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("ui\\../extra/chevrons-down.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.organize_subtasks.setIcon(icon6)
        self.organize_subtasks.setObjectName("organize_subtasks")
        self.formLayout_2.setWidget(8, QtWidgets.QFormLayout.ItemRole.LabelRole, self.organize_subtasks)
        self.organize_supertasks = QtWidgets.QPushButton(parent=self.groupBox_6)
        self.organize_supertasks.setText("")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("ui\\../extra/chevrons-up.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.organize_supertasks.setIcon(icon7)
        self.organize_supertasks.setObjectName("organize_supertasks")
        self.formLayout_2.setWidget(7, QtWidgets.QFormLayout.ItemRole.LabelRole, self.organize_supertasks)
